"""
Django settings for gestion_electrica project.
...
SECRET_KEY = 'django-insecure-4spnl#s7hakzwuso^wmi^o=xsar#c=5yg$8_w7a)#-ec3h2w9h'
...
ROOT_URLCONF = 'gestion_electrica.urls'
